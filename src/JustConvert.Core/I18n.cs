...
public static class I18n
{
    private static readonly Dictionary<string, Dictionary<string, string>> Strings = new(StringComparer.OrdinalIgnoreCase)
    {
        ["en"] = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["SetupFfmpegCheckbox"] = "Download FFmpeg (required for video & audio conversion)",
            ["SetupFfmpegFound"] = "FFmpeg detected on system",
        ...
        ["ru"] = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["SetupFfmpegCheckbox"] = "Скачать FFmpeg (необходим для конвертации видео и аудио)",
            ["SetupFfmpegFound"] = "FFmpeg уже обнаружен в системе",
            ...
            ["SetupSuccessText"] = "Just Convert готов к работе. Нажмите правой кнопкой на файл в Проводнике для конвертации.",
