...
public static class I18n
{
    internal static readonly Dictionary<string, Dictionary<string, string>> Strings = new(StringComparer.OrdinalIgnoreCase)
    {
        ["en"] = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["EncoderAmf"] = "AMD (AMF)",
            ["CodecH264"] = "H.264 (Maximum compatibility)",
            ["CodecH265"] = "H.265 / HEVC (High compression)",
            ["CodecAv1"] = "AV1 (Modern codec)",
            ["CodecVp9"] = "VP9 (Web video)",
            ["CodecProRes"] = "Apple ProRes 422",
            ["CodecCopy"] = "Copy (Without re-encoding)",
        ...
        ["ru"] = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["FormatOgg"] = "OGG (Аудио)",
            ["FormatM4a"] = "M4A (Аудио)",
            ["FormatOpus"] = "OPUS (Аудио)",
            ["FormatAiff"] = "AIFF (Аудио)",
            ["FormatBmp"] = "BMP",
            ["FormatJpg"] = "JPEG",
            ["FormatPng"] = "PNG",
            ["FormatWebp"] = "WEBP",
            ...
            ["EncoderQsv"] = "Intel (Quick Sync Video)",
            ["EncoderAmf"] = "AMD (AMF)",
            ["CodecH264"] = "H.264 (Максимальная совместимость)",
            ["CodecH265"] = "H.265 / HEVC (Высокое сжатие)",
            ["CodecAv1"] = "AV1 (Современный кодек)",
            ["CodecVp9"] = "VP9 (Для Web)",
            ["CodecProRes"] = "Apple ProRes 422",
            ["CodecCopy"] = "Копирование (Без перекодирования)",
